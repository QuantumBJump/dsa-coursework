...
\begin{tikzpicture}
    \begin{axis}[
        title={Plotting time taken to sort different size arrays (Bubble Sort)},
...
\begin{tikzpicture}
    \begin{axis}[
        title={Plotting time taken to sort different size arrays (Insertion Sort)},
        title style={yshift=1.5ex},
        xlabel={Size of Array (thousands of items)},
        ylabel={Time Taken to Sort (milliseconds)}]
...
\begin{tikzpicture}
    \begin{axis}[
        title={Plotting time taken to sort different size arrays (Merge Sort)},
        title style={yshift=1.5ex},
        xlabel={Size of Array (thousands of items)},
        ylabel={Time Taken to Sort (milliseconds)}]
...
\begin{tikzpicture}
    \begin{axis}[
        title={Plotting time taken to sort different size arrays (Quick Sort)},
        title style={yshift=1.5ex},
        xlabel={Size of Array (thousands of items)},
        ylabel={Time Taken to Sort (milliseconds)}]
