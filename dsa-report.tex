...
\begin{tikzpicture}
  \begin{axis} [
    ...
    \addplot[color=red] table[x=array size,y=bubble sort, col sep=comma] {results.txt};
    \addplot[color=orange] table[x=array size, y=insertion sort, col sep=comma] {results.txt};
    \addplot[color=blue] table[x=array size, y=merge sort, col sep=comma] {results.txt};
    \addplot[color=green] table[x=array size, y=quick sort, col sep=comma] {results.txt};
